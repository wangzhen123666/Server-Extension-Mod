...
function DrawMenu()
{
	...
	S = " " $Class'KFCommon_LocalizedStrings'.Static.GetDifficultyString (KFGRI.GameDifficulty) $"  |  尸潮波数 " $KFGRI.WaveNum $"  |  " $PC.WorldInfo.Title $"  |  00 : 00 : 00 ";
	Canvas.TextSize (S, XL, YL, FontScalar, FontScalar);
	...
	S = " 玩家数 : " $NumPlayer $"  |  存活玩家 : " $NumAlivePlayer $"  |  观看者 : " $NumSpec $" ";
	Canvas.TextSize (S, XL, YL, FontScalar, FontScalar);
...
defaultproperties
{
	...
	Begin Object Class=KFGUI_RightClickMenu_CD Name=PlayerContextMenu
		...
		ItemRows.Add((Text="静音玩家"))
		ItemRows.Add((Text="投票踢出玩家"))
