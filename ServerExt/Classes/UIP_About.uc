...
defaultproperties
{
	...
	Begin Object Class=KFGUI_TextField Name=AboutText
		...
		XSize=0.95
		YSize=0.8
		Text="#{F3E2A9}Server Extension Mod#{DEF} - 作者：Marco||授权:|#{01DF3A}Forrest Mark X#{DEF} - 第一人称腿和背包武器的实现.|汉化：|柯里昂之主（CORLEONE）|#{FF00FF}Sheep#{DEF} - Beta测试.|Mysterial - UT2004RPG MOD创意.|其他所有测试人员..."
	End Object
	Begin Object Class=KFGUI_Button Name=AboutButton
		ID="Author"
		ButtonText="作者简介"
		Tooltip="浏览作者steam个人界面"
		XPosition=0.7
		YPosition=0.92
		XSize=0.27
		YSize=0.06
