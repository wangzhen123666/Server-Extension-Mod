...
defaultproperties
{
	...
	Begin Object Class=KFGUI_ColumnList Name=CurrentVotesList
		...
		YSize=0.25
		ID="Votes"
		Columns.Add((Text="游戏",Width=0.2))
		Columns.Add((Text="地图名称",Width=0.5))
		Columns.Add((Text="投票数",Width=0.15))
		Columns.Add((Text="投票几率",Width=0.15))
	...
	Begin Object Class=KFGUI_ColumnList Name=MapList
		...
		ID="Maps"
		Columns.Add((Text="地图名称",Width=0.5))
		Columns.Add((Text="序列",Width=0.18))
		Columns.Add((Text="使用次数",Width=0.18))
		Columns.Add((Text="投票几率",Width=0.14))
		OnSelectedRow=SelectedVoteRow
	End Object
	...
	Begin Object Class=KFGUI_RightClickMenu Name=MapRClicker
		ItemRows(0)=(Text="投票这张地图")
		ItemRows(1)=(Text="管理员强制切换地图",bDisabled=true)
