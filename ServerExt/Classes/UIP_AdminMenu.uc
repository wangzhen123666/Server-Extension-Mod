...
defaultproperties
{
	Begin Object Class=KFGUI_RightClickMenu Name=PlayerContextMenu
		...
		ItemRows.Add((Text="增加职业一级",Value=4))
		ItemRows.Add((Text="设置职业等级",Value=-1))
		ItemRows.Add((Text="设置转生等级",Value=-2))
		ItemRows.Add((bSplitter=true))
		ItemRows.Add((Text="重置所有属性点",Value=5))
		ItemRows.Add((Text="重置所有特性",Value=6))
		ItemRows.Add((bSplitter=true))
		ItemRows.Add((Text="删除 1000 经验",Value=7))
		ItemRows.Add((Text="删除 10000 经验",Value=8))
		ItemRows.Add((bSplitter=true))
		ItemRows.Add((Text="重置所有状态",Value=0))
		ItemRows.Add((Text="重置当前职业状态",Value=1))
	...
	Begin Object Class=KFGUI_ColumnList Name=PlayerList
		...
		Columns.Add((Text="击杀数",Width=0.15))
		Columns.Add((Text="经验数",Width=0.15))
